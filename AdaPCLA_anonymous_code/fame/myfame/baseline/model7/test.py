...
DEFAULT_SAVE_DIR = "MODEL7_DIR/save"
...
def main(args):
    ...
    ckpt_path = args.ckpt_path or os.path.join(args.save_dir, "model7.pt")
...
if __name__ == "__main__":
    ...
    p.add_argument("--ckpt_path", default=None, help="Optional checkpoint path (default: <save_dir>/model7.pt)")
